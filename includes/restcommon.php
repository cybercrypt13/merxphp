...
//08.20.2015 ghh -  this function verifies the bsvkey is valid and that the 
//vendor running merx has it stored safely in their local database.
function verifyBSV( $bsvkey )
{
global $db;
global $requestvars;
