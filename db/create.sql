...
drop table if exists `tableversion`;
create table tableversion( VersionID int unsigned not null auto_increment primary key, 
LastUpdated datetime comment 'When last table update was run',
Version int comment 'The table version that ran') 
engine=innodb DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci comment 'maintains latest table version that ran to help with updates';
